...
//used to set up the view when the game starts
setup(){
...
//call thegame.check()method that’s used to check if the answer submitted by the player is correct.
check(event){
...
//add an event handler that fires when the form is submitted
